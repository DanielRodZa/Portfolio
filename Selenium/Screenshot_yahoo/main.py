...
send_to = [x.replace('\n','') for x in emails] # Se leen los detinatarios desde un archivo fuera del script
...
def main():
    ...
    for i in range(3):
        ...
        # Change this path to your current project path
        screenshot_path = f'/Image_{current_time.hour}_{current_time.minute}_{current_time.second}.png'
        driver.refresh()
...
def send_mail(img_path_list):
    ...
    """
    with open('../credenciales.txt','r') as credentials: # Se leen las credenciales por fuera del script para seguridad
